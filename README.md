...
## Public comparison layer

The public notebooks are comparison notebooks, not a rewrite of the main GM note. The theory machinery is abstracted from any single reporting-unit convention. Numerical work is carried out through explicit mapping layers for comparison with catalog data. The current public notebooks cover Solar, Hydrogen, and Galactic/GR windows and keep the comparison layer separate from theorem space.

---

## Repository contents

- `notebooks/` — public comparison notebooks.
- `CITATION.cff` — citation metadata.
- manuscript sources / exports for the main **General Mechanics** text.
- AF / AFC support material used for public comparison and bookkeeping.
...
Then open the desired notebook in `notebooks/`.
...
If this repository is used in research, cite the repository Zenodo record together with the primary *General Mechanics* manuscript DOI listed above.
