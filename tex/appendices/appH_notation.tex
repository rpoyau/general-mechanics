...
\item \textbf{Integral and cut forms.} For $U\times[t_0,t_1]$,
      ...
      \)
      (cut identity), see \eqref{eq:cut-identity}.
...
\item \textbf{Screens/sectors.} For screens of radius $r$ in $n$D,
      ...
      \ref{corollary:static-screen}, \ref{corollary:dimensional}).
\end{itemize}
...
\item \textbf{Windowed Fano factor and effective window.}
      ...
      count autocorrelation on the same record. See C6 \eqref{eq:c6-crb-jbar}, \eqref{eq:c6-var-EI} and §\ref{subsec:op-noise} \eqref{eq:op-noise}.
\end{itemize}
...
\item[$F_A,\ \Delta t_{\!\mathrm{eff}}$] Windowed Fano factor and effective window (C6 \eqref{eq:c6-crb-jbar}, \eqref{eq:c6-var-EI}; §\ref{subsec:op-noise} \eqref{eq:op-noise}).
