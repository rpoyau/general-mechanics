...
\item \textbf{Causality/dispersion (comparison witness).}
      ...
      on a window—the measured/adopted dispersion may be \emph{compared} against the Kramers--Kronig relations
      recorded in App.~\ref{appB:KK}. This is a local witness, not a global postulate.
\end{itemize}
