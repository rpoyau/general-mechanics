...
\item \textbf{Screens/sectors.} For screens of radius $r$ in $n$D,
      $A_n(r)=S_{n-1}\,r^{\,n-1}$ (Appendix~\ref{app:nD-boundaries}, eq.~\eqref{app:nD-boundaries:eq:areas}).
...
\item[$A_n(r),\ S_{n-1}$] Screen area and unit-sphere area; App.~\ref{app:nD-boundaries}, eq.~\eqref{app:nD-boundaries:eq:areas}.
