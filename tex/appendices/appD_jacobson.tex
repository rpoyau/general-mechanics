...
on the same manifold region and boundary; it is not taken as an axiom (see \S\ref{corollary:geometry} for the operational use of focusing and area evolution).
\end{itemize}
...
same region and supports the geometry‑as‑tool perspective (see \S\ref{corollary:geometry}).
