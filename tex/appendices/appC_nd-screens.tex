% ======================================================================
% appC_nd-screens.tex — Appendix C: Boundaries in n dimensions
% ======================================================================
...
used in the main text (§\ref{corollary:info-gas}, §\ref{corollary:frame-boundary}).
...
Frame boundary laws: §\ref{corollary:info-gas}, §\ref{corollary:frame-boundary}. 
Dimensional flows and confinement: §\ref{corollary:dimensional}.
Wave transport \& envelopes (far field): §\ref{waves}.
...
These are provenance pointers; the identities used here follow directly from \eqref{axioms:stokes:identity:eq} / \eqref{axioms:stokes:frame} and the formulas above.
