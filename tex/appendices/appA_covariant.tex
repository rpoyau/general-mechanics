...
% ------------------------------------------------------------
\subsection{Space–time background}
...
\subsection{Informational current}
...
\subsection*{Informational force}
...
\subsection*{Resource–clock bound}
...
\subsection*{Stokes on extended tubes}
