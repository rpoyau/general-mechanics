...
form used when $A_{n-1}(r,t)$ varies in time.
...
when retarded response is observed on a window—the measured/adopted dispersion may be \emph{compared} against the
Kramers--Kronig Hilbert–transform relations recorded in \S\ref{appB:KK}, eq.~\eqref{appB:eq:KK}.} This is a local
diagnostic/witness, not a global postulate.
