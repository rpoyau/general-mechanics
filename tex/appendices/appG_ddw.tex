...
Statements are Stokes‑first: the closure of a multisymplectic form yields
the covariant De Donder–Weyl (DDW) Hamilton equations. Sector mappings are specified
outside the axioms.
...
analogue of the boundary cut identity (cf.\ \eqref{eq:cut-identity}) and echoes the
