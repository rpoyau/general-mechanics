...
All statements are Stokes‑first: the closure of a multisymplectic form yields
the covariant De Donder–Weyl (DDW) Hamilton equations. No action postulate is
assumed; sector mappings remain outside the axioms.
...
% ----------------------------- G.6 -------------------------------------
\subsection{Conservation law (Noether‑free statement)}
...
there, yielding a local balance law (a covariant generalization of energy–momentum
flow). This is the field analogue of the boundary cut balance (cf.\ \eqref{eq:cut-balance})
and mirrors the informational balance \eqref{eq:stokes-identity}.
...
\end{equation}
mirroring the informational balance \eqref{eq:stokes-identity}.
...
informational 1‑form preserves the structure. A $3{+}1$ split recovers the canonical
...
For the particle Poincar\'e–Cartan/Hamiltonian structure see Arnold~\cite{Arnold1989}; our use here is Stokes‑first and
motivation‑free. The general differential‑forms/Stokes conventions are summarized in App.~\ref{app:forms-stokes}.
