...
On an open segment \(W\subset\mathcal T\) with \(\sigma|_W\equiv 0\) and directed speed profile
...
attenuation factor in C11 (\S\ref{corollary:entropic-corrections}), multiplying the inverse–area rule.
