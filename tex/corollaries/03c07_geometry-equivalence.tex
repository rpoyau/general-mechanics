...
On the \emph{same} region used for flux measurements, the framework employ a single sector calibration (see \S\ref{subsec:op-calibration}) that ties the focusing term
