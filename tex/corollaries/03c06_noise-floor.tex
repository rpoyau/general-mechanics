...
Using the static closure \eqref{eq:static-closure}, $\ \mathbf j=-\kappa\,\mathbf E_I$, the snapshot
...
\label{eq:c6-var-EI}
\end{equation}
Thus the \emph{force estimate} has a windowed cloud whose width decreases only as $\Delta t^{-1/2}$
...
\label{eq:c6-corr}
\end{equation}
This reproduces \eqref{eq:c6-crb-jbar} (alias \eqref{eq:c6-witness-jbar}) when one identifies
