...
(App.~\ref{app:nD-screens}, eq.~\eqref{app:nD-boundaries:eq:areas}). On a steady, source‑free annulus the tube/boundary flux
...
Here \(A_n(r)\) is the \(n\)D boundary area (App.~\ref{app:nD-screens}). Frame scaling follows \eqref{eq:c8-static};
...
Background geometry/areas and cone/tube forms are summarized in App.~\ref{app:nD-screens}; the exported‑power
