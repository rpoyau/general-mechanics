...
\label{eq:c4-ied}
\end{equation}
where $A_I$ is a $1$-form potential, $F_I$ the $2$-form field, and $\chi$ a linear, local, causal
constitutive map on the segment considered. This is a \emph{closure choice} (not an axiom of the
framework). \emph{Causality of $\chi$ implies Kramers--Kronig dispersion relations}, see
App.~\ref{app:forms-stokes}, eq.~\eqref{appB:eq:KK}.
...
$\mathbf S$ obeying a local conservation identity on source--free segments. Info--EM is one such closure. Others—
...
Our Poynting and causality statements are recalled in App.~\ref{app:forms-stokes}. Standard expositions include
Jackson~\cite{Jackson1999} and Landau--Lifshitz--Pitaevskii~\cite{LandauLifshitzEDCM1984}; for dispersion/causality
see Nussenzveig~\cite{Nussenzveig1972}.
