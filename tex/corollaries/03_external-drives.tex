...
The directed inlet/outlet fluxes (using \S\ref{axioms:directional-split}) are
\[
...
on \(\mathcal T\times[t_0,t_1]\) yields the same balance \eqref{eq:c3-cut}. A co‑moving frame replaces \(\partial_t\) by
