...
\paragraph{Setup.}
On \((q,t)\) as in \axref{axioms:path-rate}, the canonical rate equations \eqref{axioms:path-rate:eq:canonical} hold.
...
\end{equation}
Using the Poincaré–Cartan form \(\Theta_{\mathcal R}=P_i\,dq^i- H\,dt\) \axref{axioms:path-rate},
