...
Figure \ref{fig:lattice_potential} shows the resulting confinement.

% ---------- Figure 3 – potential ----------
\begin{figure}[ht]
  \centering
  \resizebox{.72\linewidth}{!}{\input{figs/lattice_potential}}%
  \caption{One-dimensional sinusoidal confinement potential used in the
           Kick-lattice toy model. Red dots mark the minima.}
...
\begin{figure}[ht]
  \centering
  \resizebox{.72\linewidth}{!}{\input{figs/entropy_density}}%
  \caption{Entropy density \(\rho(x)\) for three barrier strengths.
           Colours: blue \(D_{\mathrm{bar}}/D_{\mathrm{in}}=10^{-1}\),
           orange \(10^{-2}\), green \(10^{-3}\).}
  \label{fig:entropy_density}
\end{figure}

%% \begin{figure}[H]            % same style as other figures
%%   \centering
%%   \resizebox{.72\linewidth}{!}{\input{figs/entropy_density}}%
%%   \caption{One–dimensional sinusoidal confinement potential used in the
%%            Kick-lattice toy model.  Red dots mark the minima.}
