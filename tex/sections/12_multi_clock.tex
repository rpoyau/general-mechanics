...
+\subsection{Vacuum-Limited Channel}\label{sec:vacuum_channel}
+Choosing the vacuum world-tube as the unique physical channel (cf.\ Sec.~\ref{sec:info_currents})
+makes the generalised Stokes balance act as a capacity ledger: logical sub-channels
+share the same resource vector \(R^{(a)}\) and compete under the REOS constraint.
