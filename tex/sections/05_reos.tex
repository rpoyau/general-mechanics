...
\section{Differential form of REOS}\label{sec:reos_equation}
...
\item supplying an explicit \(R^{(a)}\!\mapsto\!C(R^{(a)})\) constraint
      recovers classical capacity ceilings (Secs.~\ref{sec:info_field_div}--\ref{sec:tier1_jacobson}).
\end{enumerate}
