...
(These are the window‑level specializations corresponding to \axref{axioms:waves:closure}.)
...
For moving boundaries, the side integrand is \(\mathbf j\!\cdot\! \mathbf n - i\,v_n\) \apref{app:glossary:worldtube}.
