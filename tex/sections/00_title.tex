...
\title{\bfseries
  The Relational Information Model \\[2pt]
  \large A Note on the REOS Axiom and Energy--Time Flow in the Vacuum Channel}

\author{
  Reginald Poyau
  First\,A.~Author\thanks{Institute, University, Country} \and
  Second\,B.~Author\thanks{Institute, University, Country}
}
