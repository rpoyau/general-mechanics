...
\section{Anchor Corollary II: Least–Action Formulation}
...
(wave propagation), or a curved-space Laplace–Beltrami tensor
$A^{ij}=g^{ij}(\mathbf x)$.}
and enforce the axiom with a Lagrange multiplier~$\lambda$.
