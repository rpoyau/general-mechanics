...
Stokes identity is $d(*j)=\sigma\,\mathrm{vol}$ (continuity).\footnote{Local and \emph{cut identity}
forms appear in \eqref{eq:stokes-identity}–\eqref{eq:cut-identity} once the axioms are stated.}
