...
\section{Informational Currents and the World-Tube}\label{sec:info_currents}
...
\begin{figure}[H]
  \centering
  \input{figs/world_tube}%  % adjust path if needed; no .tex extension
...
\]
This partition-independence underpins the capacity trade-offs developed in
+Secs.~\ref{sec:info_field_div}--\ref{sec:tier1_jacobson}.
