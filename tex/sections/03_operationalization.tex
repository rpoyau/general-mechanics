...
\emph{wave transport closure} that provides a Poynting identity on
...
\begin{enumerate}\itemsep2pt
  ...
  \item \textbf{Channel class.} Static (use $\mathbf j=-\kappa\,\mathbf E_I$) or a \emph{wave
        ...
        $\mathbf S$ satisfies \eqref{appB:eq:poynting}; C4 shows one realization via Info–EM,
...
\begin{enumerate}\itemsep2pt
  ...
  \item Apply \eqref{eq:stokes-identity} and the cut identity \eqref{eq:cut-identity} with $\sigma=0$ on the annulus to identify
