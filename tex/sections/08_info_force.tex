...
\label{sec:info_force}\label{sec:force}
...
\subsection{Example 1: Inhomogeneous Diffusive Bus}\label{subsec:force-example}
\begin{itemize}
...
In Secs.~\ref{sec:info_field_div}--\ref{sec:tier1_jacobson} the channel capacity ceiling
